...
if (!function_exists('vm_template_news_hero_header')) {
    function vm_template_news_hero_header()
    {
        ...
        <div class="news-hero text-center text-white">
            <div class="container">
                <div class="hero-inner">
                    <h2 class="vm-title">Blog</h2>
                    <p class="vm-subtitle"><?= get_bloginfo('description'); ?></p>
                </div>
            </div>
        </div>
