...
function vm_item_daily_tour($class = '')
{
    ...
    if (has_term('package-tours', 'tour_cats')) {
        $location = get_field('location_tour');
    }
    ...
    <a href="<?= the_permalink(); ?>" class="tour-item <?= $class ?>" aria-label="read more <?php the_title() ?>">
        ...
        <div class="tour-item-content">
            ...
            <?php if (isset($location) && !empty($location)): ?>
                <div class="tour-item__location d-flex">
...
function vm_hero_section_shared($title = '', $image = '')
{ ?>
...
function vm_car_tour_item($class = '')
{
    ...
    <a class="car-item <?= esc_attr($class) ?>" href="<?= the_permalink(); ?>"
        ...
        <div class="car-item__body">
            ...
            <div class="car-item__meta d-flex align-items-center justify-content-between">
                ...
                <!-- CTA -->
                <span class="car-item__cta vm-button" role="button"
...
{ ?>
    <div id="header-booking-top" class="vm-header-booking-top d-md-none">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="#vm-booking-form" class="vm-button" label="Book a tour" data-scroll-target="#vm-booking-form">
                Book Now
            </a>
        </div>
    </div>
