...
$paragraph = $itinerary_tour['itinerary_paragraph'];
$show_paragraph = $itinerary_tour['enable_itinerary_paragraph'] ?? false;
?>
<?php if (!empty($time_line) || !empty($paragraph)): ?>
