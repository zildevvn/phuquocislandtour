...
$heading = get_field('hd_faq_location', $term);
$sub_hd = get_field('sub_hd_faq_location', $term);
$img = get_field('img_faq_location', $term);
$hd_img = get_field('hd_img_faq_location', $term);
$faqs = get_field('faqs_list_location', $term);
?>
<?php if (!empty($faqs)): ?>
